...
DROP TABLE webacula_dt_resources;
...
DROP TABLE webacula_client_acl;
...
DROP TABLE webacula_command_acl;
...
DROP TABLE webacula_dt_commands;
...
DROP TABLE webacula_fileset_acl;
...
DROP TABLE webacula_storage_acl;
...
-- PHP session storage
DROP TABLE webacula_php_session;
...
GRANT all ON webacula_users TO ${PG_USER};
GRANT all ON webacula_roles TO ${PG_USER};
GRANT all ON webacula_resources TO ${PG_USER};
GRANT all ON webacula_dt_resources TO ${PG_USER};
GRANT all ON webacula_client_acl TO ${PG_USER};
GRANT all ON webacula_command_acl TO ${PG_USER};
GRANT all ON webacula_dt_commands TO ${PG_USER};
GRANT all ON webacula_fileset_acl TO ${PG_USER};
GRANT all ON webacula_job_acl TO ${PG_USER};
GRANT all ON webacula_pool_acl TO ${PG_USER};
GRANT all ON webacula_storage_acl TO ${PG_USER};
GRANT all ON webacula_where_acl TO ${PG_USER};
GRANT all ON webacula_php_session TO ${PG_USER};
...
sudo -u postgres psql -h $PG_HOST -q -f - -d $db_name $*  <<END-OF-DATA
